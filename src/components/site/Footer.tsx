...
export const Footer = () => (
  <footer className="bg-primary text-primary-foreground">
    <div className="container py-12 md:py-16">
      <div className="grid grid-cols-3 md:grid-cols-4 gap-6 md:gap-10">
        <div className="col-span-3 md:col-span-1">
          <div className="flex items-center gap-3 mb-4">
            <img src="/logo-transparent.png" alt="Kayaloram Logo" className="h-14 md:h-20 w-auto object-contain brightness-0 invert" />
        ...
        {[
          ...
          <div key={col.title}>
            <p className="font-display text-xs uppercase tracking-widest opacity-60 mb-4">{col.title}</p>
      ...
      <div className="mt-10 md:mt-12 pt-6 border-t border-primary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-xs opacity-60 text-center md:text-left">© {new Date().getFullYear()} Kayaloram Retreat · All rights reserved</p>
